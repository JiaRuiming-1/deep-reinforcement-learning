...
#from reinforcement_learning.Value_based_methods.p1_navigation.segment_tree \
from segment_tree import MinSegmentTree, SumSegmentTree

'''
DQN with n-step buffer
'''
class ReplayBuffer:
...
'''
Prioritized buffer inherit DQN replaybuffer
'''
